...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Edit classifications #{{ $task->id }}</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/classifications/' . $task->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ method_field('PATCH') }}
                            {{ csrf_field() }}
                            ...
                            <div class="form-group {{ $errors->has('task_id') ? 'has-error' : ''}}">
                                ...
                                <div class="col-md-8">
                                    {!! Form::select('task_id', $tasks, $task->id, ['class' => 'form-control select2-single','disabled'=>'disabled']) !!}
