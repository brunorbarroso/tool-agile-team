...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Tarefa {{ $task->id }}</div>
                    <div class="card-body">
                        ...
                        <a href="{{ url('/admin/tasks/' . $task->id . '/edit') }}" title="Edit Tarefa"><button class="btn btn-primary btn-sm"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</button></a>
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                <tbody>
                                    ...
                                    <tr><th> Codigo </th><td> {{ $task->code }} </td></tr><tr><th> Titulo </th><td> {{ $task->title }} </td></tr>
                                </tbody>
                            </table>
                        </div>
