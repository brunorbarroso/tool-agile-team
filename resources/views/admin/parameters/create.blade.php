...
@section('content')
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="card">
                    <div class="card-header">Create New Parametro</div>
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('/admin/parameters') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
                            {{ csrf_field() }}
